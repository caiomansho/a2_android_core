...
public class CpfValidatorInputType implements ValidatorInputType {

    private EditText editText;
    private Context context;

    public CpfValidatorInputType(Context context, EditText editText) {
    ...
    public Boolean isValid() {
        if (!editText.getText().toString().isEmpty() && !editText.isCpf()) {
            ...
            if (editText.getCustomErrorMessageId() != 0) {
                ...
                editText.setError(context.getString(R.string.sou_widgets_invalid_cpf));
