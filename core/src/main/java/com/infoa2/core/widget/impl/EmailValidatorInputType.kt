...
class EmailValidatorInputType(private val context: Context, private val editText: EditText) : ValidatorInputType {

    override val isValid: Boolean
        get() {
            if (!editText.text!!.toString().isEmpty() && !editText.isEmail) {
                ...
                if (editText.customErrorMessageId != 0) {
                    ...
                    editText.error = context.getString(R.string.sou_widgets_invalid_email)
